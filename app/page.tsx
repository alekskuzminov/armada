...
const services = [
  {
    ...
    href: '/services/tokarnye-raboty-s-chpu',
  ...
  },
  {
    ...
    icon: 'ri-tools-line',
    href: '/services/frezernaya-obrabotka-s-chpu',
  ...
  },
  {
    ...
    icon: 'ri-stack-line',
    href: '/services/izgotovlenie-detalej-na-zakaz',
    image: 'https://buelifmopuduegur.begetcdn.cloud/images/home/сustom-made-parts.webp',
  },
  {
    title: 'Электроэрозионная обработка',
    desc: 'Электроэрозионные работы на проволочно-вырезных станках. Вырезка контуров любой сложности в закалённых сталях и твёрдых сплавах.',
    icon: 'ri-flashlight-line',
    href: '/services/elektroerozionnaya-obrabotka',
    image: '/images/home/edm-preview.webp',
  },
  {
    title: 'Шлифовальные работы',
    desc: 'Плоскошлифовальная, круглошлифовальная и профилешлифовальная обработка. Достижение высокой точности размеров и качества поверхности.',
    icon: 'ri-settings-4-line',
    href: '/services/shlifovalnye-raboty',
    image: '/images/home/grinding-preview.webp',
  },
  {
    title: 'Термообработка',
    desc: 'Объёмная термообработка металлов, в том числе быстрорежущих и нержавеющих сталей. Закалка, отпуск, отжиг, нормализация.',
    icon: 'ri-fire-line',
    href: '/services/termoobrabotka',
    image: '/images/home/heat-treatment-preview.webp',
  },
];
...
const processSteps = [
  ...
  },
  {
    ...
    desc: 'Технолог анализирует деталь, подбирает материал, оснастку и рассчитывает стоимость за 24 часа.',
  },
  {
    num: '03',
    title: 'Согласование',
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Отправьте чертёж или опишите задачу — рассчитаем стоимость и сроки за 24 часа.
            ...
            <div className="bg-white rounded-2xl p-8 shadow-sm border border-gray-100">
              <ContactFormBlock
                ...
                subheading="Заполните форму — мы свяжемся в течение 24 часов"
                fields={[
                  'name',
                  'phone',
                  'email',
